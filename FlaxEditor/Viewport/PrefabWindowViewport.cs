...
namespace FlaxEditor.Viewport
{
    ...
    public class PrefabWindowViewport : PrefabPreview, IGizmoOwner
    {
        ...
        : base(true)
        {
            ...
            var enableScaleSnapping = new ViewportWidgetButton(string.Empty, window.Editor.UI.GetIcon("ScaleStep16"), null, true)
            {
            ...
            var enableRotateSnapping = new ViewportWidgetButton(string.Empty, window.Editor.UI.GetIcon("RotateStep16"), null, true)
            {
            ...
            var enableTranslateSnapping = new ViewportWidgetButton(string.Empty, window.Editor.UI.GetIcon("Grid16"), null, true)
            {
            ...
            _gizmoModeTranslate = new ViewportWidgetButton(string.Empty, window.Editor.UI.GetIcon("Translate16"), null, true)
            {
            ...
            _gizmoModeRotate = new ViewportWidgetButton(string.Empty, window.Editor.UI.GetIcon("Rotate16"), null, true)
            {
            ...
            _gizmoModeScale = new ViewportWidgetButton(string.Empty, window.Editor.UI.GetIcon("Scale16"), null, true)
            {
