...
namespace FlaxEditor.Content.Settings
{
    ...
    public sealed class NavigationSettings : SettingsBase
    {
        ...
        [EditorOrder(70), EditorDisplay("Nav Mesh Options"), Tooltip("The maximum distance a simplfied contour's border edges should deviate from the original raw contour.")]
