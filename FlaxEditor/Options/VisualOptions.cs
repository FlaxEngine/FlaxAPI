...
namespace FlaxEditor.Options
{
    ...
    public sealed class VisualOptions
    {
        ...
        /// </summary>
        [EditorDisplay("Gizmo"), Tooltip("The first color of the selection outline gradient.")]
        public Color SelectionOutlineColor0 { get; set; } = new Color(0.039f, 0.827f, 0.156f);

        /// <summary>
        /// Gets or sets the second outline color.
        /// </summary>
        [EditorDisplay("Gizmo"), Tooltip("The second color of the selection outline gradient.")]
