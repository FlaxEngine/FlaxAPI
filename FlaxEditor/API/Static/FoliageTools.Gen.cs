...
namespace FlaxEditor
{
    ...
    public static partial class FoliageTools
    {
        ...
        public static void Paint(Foliage foliage, int[] foliageTypesIndices, Vector3 brushPosition, float brushRadius)
        {
            ...
            throw new NotImplementedException("Unit tests, don't support methods calls. Only properties can be get or set.");
#else
            Internal_Paint(Object.GetUnmanagedPtr(foliage), foliageTypesIndices, ref brushPosition, brushRadius);
#endif
        }
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void Internal_Paint(IntPtr foliage, int[] foliageTypesIndices, ref Vector3 brushPosition, float brushRadius);
#endif
