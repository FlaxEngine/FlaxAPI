...
namespace FlaxEngine
{
		...
		[Obsolete("Unit tests, don't support methods calls.")]
			...
			public T GetChild<T>() where T : Actor
			{
				...
				throw new NotImplementedException("Unit tests, don't support methods calls. Only properties can be get or set.");
#else
				return (T)Internal_GetChild(unmanagedPtr);
#endif
			}
		...
		[Obsolete("Unit tests, don't support methods calls.")]
			...
			public T[] GetChildren<T>() where T : Actor
			{
				...
				throw new NotImplementedException("Unit tests, don't support methods calls. Only properties can be get or set.");
#else
				return Array.ConvertAll(Internal_GetChildrenPerType(unmanagedPtr), x => (T)x);
#endif
			}
		...
		[Obsolete("Unit tests, don't support methods calls.")]
			...
			public T GetScript<T>() where T : Script
			{
				...
				throw new NotImplementedException("Unit tests, don't support methods calls. Only properties can be get or set.");
#else
				return (T)Internal_GetScript(unmanagedPtr);
#endif
			}
		...
		[Obsolete("Unit tests, don't support methods calls.")]
			...
			public T[] GetScripts<T>() where T : Script
			{
				...
				throw new NotImplementedException("Unit tests, don't support methods calls. Only properties can be get or set.");
#else
				return Array.ConvertAll(Internal_GetScriptsPerType(unmanagedPtr), x => (T)x);
#endif
			}
...
#region Internal Calls
		...
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern void Internal_SetPosition(IntPtr obj, Vector3 val);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern  Quaternion Internal_GetOrientation(IntPtr obj);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern void Internal_SetOrientation(IntPtr obj, Quaternion val);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern  Vector3 Internal_GetScale(IntPtr obj);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern void Internal_SetScale(IntPtr obj, Vector3 val);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern  Transform Internal_GetTransform(IntPtr obj);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern void Internal_SetTransform(IntPtr obj, Transform val);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern  Vector3 Internal_GetLocalPosition(IntPtr obj);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern void Internal_SetLocalPosition(IntPtr obj, Vector3 val);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern  Quaternion Internal_GetLocalOrientation(IntPtr obj);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern void Internal_SetLocalOrientation(IntPtr obj, Quaternion val);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern  Vector3 Internal_GetLocalScale(IntPtr obj);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern void Internal_SetLocalScale(IntPtr obj, Vector3 val);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern  Transform Internal_GetLocalTransform(IntPtr obj);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern void Internal_SetLocalTransform(IntPtr obj, Transform val);
		[MethodImpl(MethodImplOptions.InternalCall)]
		...
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern  Actor Internal_GetChild(IntPtr obj);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern  Actor[] Internal_GetChildrenPerType(IntPtr obj);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern  Actor[] Internal_GetChildren(IntPtr obj);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern  Script Internal_GetScript(IntPtr obj);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal static extern  Script[] Internal_GetScriptsPerType(IntPtr obj);
		[MethodImpl(MethodImplOptions.InternalCall)]
