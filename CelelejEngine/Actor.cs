...
namespace CelelejEngine
{
    ...
    public abstract class Actor : Object
    {
        ...
        public Vector3 Position
        {
            ...
            set { Internal_SetPosition(unmanagedPtr, value); }
        }

        public Quaternion Orientation
        {
            get { return Internal_GetOrientation(unmanagedPtr); }
            set { Internal_SetOrientation(unmanagedPtr, value); }
        }

        public Vector3 Scale
        {
            get { return Internal_GetScale(unmanagedPtr); }
            set { Internal_SetScale(unmanagedPtr, value); }
        }

        public Transform Transform
        {
            get { return Internal_GetTransform(unmanagedPtr); }
            set { Internal_SetTransform(unmanagedPtr, value); }
        }

        public Vector3 LocalPosition
        {
            get { return Internal_GetLocalPosition(unmanagedPtr); }
            set { Internal_SetLocalPosition(unmanagedPtr, value); }
        }

        public Quaternion LocalOrientation
        {
            get { return Internal_GetLocalOrientation(unmanagedPtr); }
            set { Internal_SetLocalOrientation(unmanagedPtr, value); }
        }

        public Vector3 LocalScale
        {
            get { return Internal_GetLocalScale(unmanagedPtr); }
            set { Internal_SetLocalScale(unmanagedPtr, value); }
        }

        public Transform LocalTransform
        {
            get { return Internal_GetLocalTransform(unmanagedPtr); }
            set { Internal_SetLocalTransform(unmanagedPtr, value); }
        }
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void Internal_SetPosition(IntPtr obj, Vector3 value);
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void Internal_SetOrientation(IntPtr obj, Quaternion value);
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void Internal_SetScale(IntPtr obj, Vector3 value);
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void Internal_SetTransform(IntPtr obj, Transform value);
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void Internal_SetLocalPosition(IntPtr obj, Vector3 value);
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void Internal_SetLocalOrientation(IntPtr obj, Quaternion value);
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void Internal_SetLocalScale(IntPtr obj, Vector3 value);
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern void Internal_SetLocalTransform(IntPtr obj, Transform value);
