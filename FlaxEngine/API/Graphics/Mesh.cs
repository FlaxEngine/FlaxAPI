...
namespace FlaxEngine
{
    partial class Mesh
    {
        ...
        /// </summary>
        public Model ParentModel => (Model)Internal_GetParentModel(unmanagedPtr);
        ...
        public Vertex1[] DownloadVertexBuffer1(bool forceGpu = false)
        {
            ...
            if (Internal_DownloadBuffer(unmanagedPtr, forceGpu, result, (int)InternalBufferType.VB1))
                throw new FlaxException("Failed to download mesh data.");
            return result;
        }
        ...
        public Vertex2[] DownloadVertexBuffer2(bool forceGpu = false)
        {
            ...
            if (Internal_DownloadBuffer(unmanagedPtr, forceGpu, result, (int)InternalBufferType.VB2))
                throw new FlaxException("Failed to download mesh data.");
            return result;
        }
