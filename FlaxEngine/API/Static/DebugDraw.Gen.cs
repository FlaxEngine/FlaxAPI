...
#endif
        [UnmanagedCall]
        public static void Draw(FlaxEngine.RenderTask task, IntPtr[] selectedActors, FlaxEngine.RenderTarget target = null, FlaxEngine.GPUContext context = null, FlaxEngine.RenderTarget depthBuffer = null, bool enableDepthTest = false)
        {
#if UNIT_TEST_COMPILANT
            throw new NotImplementedException("Unit tests, don't support methods calls. Only properties can be get or set.");
#else
