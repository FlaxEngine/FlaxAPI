...
namespace FlaxEngine
{
    ...
    public sealed partial class SpotLight : LightWithShadow
    {
        ...
        /// </summary>
        [UnmanagedCall]
        [EditorOrder(21), DefaultValue(10.0f), EditorDisplay("Light"), Tooltip("Light inner cone angle (in degrees)"), Limit(1, 80, 0.1f)]
        ...
        /// </summary>
        [UnmanagedCall]
        [EditorOrder(22), DefaultValue(43.0f), EditorDisplay("Light"), Tooltip("Light outer cone angle (in degrees)"), Limit(1, 80, 0.1f)]
