...
namespace FlaxEngine
{
    ...
    public struct LimitConeRange
    {
        ...
        /// <summary>
        /// The Y angle of the cone (in degrees). Movement is constrainted between 0 and this angle on the Y axis.
        /// </summary>
        [EditorOrder(50), Limit(0.1f, 179.9f), Tooltip("The Y angle of the cone (in degrees). Movement is constrainted between 0 and this angle on the Y axis.")]
        public float YLimitAngle;

        /// <summary>
        /// The Z angle of the cone (in degrees). Movement is constrainted between 0 and this angle on the Z axis.
        /// </summary>
        [EditorOrder(60), Limit(0.1f, 179.9f), Tooltip("The Z angle of the cone (in degrees). Movement is constrainted between 0 and this angle on the Z axis.")]
