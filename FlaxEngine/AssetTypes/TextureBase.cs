...
namespace FlaxEngine
{
    ...
    public abstract class TextureBase : BinaryAsset
    {
        ...
        /// <summary>
        /// Initializes the texture storage container with teh given data. Valid only for virtual assets. Can be used in both Editor and at runtime in a builded game.
